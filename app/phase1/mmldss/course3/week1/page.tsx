                                                ...
                                                <Tab2 title="Labs & Assignments" isChecked={false}>
                                                        <TileRowCell0>
                                                                ...
                                                                <div className='lab-links'>
                                                                        <a href="/C3_W1_Lab_1_Monty_Hall.html" target="_blank">Lab: The Monty Hall Problem</a>
                                                                        <br /><br />
                                                                        <a href="/C3_W1_Lab_2_Birthday_Problems.html" target="_blank">Lab: Birthday Problems</a>
                                                                        <br /><br />
