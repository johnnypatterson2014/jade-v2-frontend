                                        ...
                                        <Tabs>
                                                <Tab2 title="Review of Probability Theory" isChecked={true}>
                                                        <TileRowCell0>
                                                                ...
                                                                <h1 id="review-of-probability-theory">Probability Theory</h1><br />

                                                                <h1 id="2-1-cumulative-distribution-function-cdf-">2.1 Cumulative Distribution Function (CDF)</h1>
                                                                <p>The <strong>CDF</strong> is defined as... enter better description</p>

                                                                <h1 id="2-2-probability-mass-function-pmf-">2.2 Probability Mass Function (PMF)</h1>
                                                                <p>The <strong>PMF</strong> is defined as... enter better description</p>
                                                ...
                                                <Tab2 title="Reference Material" isChecked={false}>
                                                        <TileRowCell0>
