                                                ...
                                                <Tab2 title="Labs & Assignments" isChecked={false}>
                                                        <TileRowCell0>
                                                                ...
                                                                <div className='lab-links'>
                                                                        ...
                                                                        <ul>
                                                                                <li><a href="/C1_W4_Lab_1_Interpreting_eigenvalues_and_eigenvectors.html" target="_blank">Lab: Interpreting eigenvalues and eigenvectors</a></li>
                                                                                <li><a href="/C1W4_Assignment.html" target="_blank">Assignment: Webpage navigation model and PCA</a></li>
