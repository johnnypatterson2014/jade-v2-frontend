                                                ...
                                                <Tab2 title="Labs & Assignments" isChecked={false}>
                                                        <TileRowCell0>
                                                                ...
                                                                <div className='lab-links'>
                                                                        ...
                                                                        <ul>
                                                                                <li><a href="/C1W2_UGL_solving_linear_systems_3_variables.html" target="_blank">Lab: Introduction to the Numpy.linalg sub-library</a></li>
                                                                                <li><a href="/C1W2_Assignment.html" target="_blank">Assignment: gaussian elimination</a></li>
