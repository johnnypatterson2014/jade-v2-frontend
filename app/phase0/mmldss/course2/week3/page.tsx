                                                ...
                                                <Tab2 title="Labs & Assignments" isChecked={false}>
                                                        <TileRowCell0>
                                                                ...
                                                                <div className='lab-links'>
                                                                        ...
                                                                        <ul>
                                                                                <li><a href="/C2_W3_Lab_1_Regression_with_Perceptron.html" target="_blank">Lab: C2_W3_Lab_1_Regression_with_Perceptron</a></li>
                                                                                <li><a href="/C2_W3_Lab_2_Classification_with_Perceptron.html" target="_blank">Lab: C2_W3_Lab_2_Classification_with_Perceptron</a></li>
                                                                                <li><a href="/C2_W3_Lab_3_Optimization_Using_Newtons_Method.html" target="_blank">Lab: C2_W3_Lab_3_Optimization_Using_Newtons_Method</a></li>
                                                                                <li><a href="/C2_W3_Assignment.html" target="_blank">Assignment: Neural Network with Two Layers</a></li>
                                                                        </ul>
